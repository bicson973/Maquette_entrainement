// FEUILLE JAVASCRIPT - STRUCTURE DE CONTROLE - INTRO - SEMA 
...
// Contenu égal en type de données et en valeur
console.log(egalValeurType); 

let differenceValeur = x != 4;
// différent de 
console.log(differenceValeur);

let differenceValeurType = x !=='4';
...
//     '\n Valeur dans x different de 4 (en valeur OU en type) ? '  + differentValeurType +
